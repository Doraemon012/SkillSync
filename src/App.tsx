    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <>
              <EventList /> <PageTitle title="Events | SkillSync" />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <Dashboard /> <PageTitle title="Dashboard | SkillSync" />
            </>
          }
        />
        ...
        <Route
          ...
          element={
            <>
              <ArticlesHomepage /> <PageTitle title="Articles | SkillSync" />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <ArticleWritingPage />{" "}
              <PageTitle title="Create Article | SkillSync" />
            </>
          }
        />
